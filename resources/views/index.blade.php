<!DOCTYPE html>
  ...
  <span class="brand-text invisible d-none d-lg-inline-block" id="brand-text">Amber and Emerald</span>
    ...
    <main>
        <section class="container-fluid section-header pt-3">
          <div class="row h-100">
        ...
        <section class="container">
          <div class="row">
            <div class="col-12 py-5" id="portfolio">
              ...
              <div class="portfolio-item">
                <span class="subhead">Decarbonising Industrial Sites</span>
                <h3>Flex Power Solutions</h3>
                <p>
                  This Irish company resounded with me for their efforts to make a cleaner, more energy efficient future for our country. Flex Power Solutions specialise in maximising efficiencies for the energy generated by renewable sources by diverting it into high-efficieny heat generation during periods of excess generation. This just makes sense - don't turn your wind turbines off, divert the excess power to other resources that will allow you to decarbonise your entire industrial plant. 
                </p>
                <div class="tech">
                  <span>Overview:</span>
                  <ul>
        ...
        <section class="section-services">
          <div class="container">
            <div class="row py-5">
              <div class="col-12 col-lg-5 offset-lg-7 py-5" id="services">
          ...
          <section class="container">
            <div class="row">
              <div class="col-12" id="">
                <h2 class="mt-5">Small Business Website</h2>
                <p>
                ...
                <div class="row">
                  <div class="col-12 col-md-6 col-lg-4">
                    <div class="box">
                      <img src="/img/wordpress.svg" alt="Wordpress CMS" class="icon">
                      <p>
                        Your site will be built on the world-renowned WordPress CMS so the business owner can update and add their own conten
                      </p>
                    </div>
                  </div>
                  <div class="col-12 col-md-6 col-lg-4">
                    <div class="box">
                      <img src="/img/wordpress.svg" alt="Wordpress CMS" class="icon">
                      <p>
                        Your site operates on the world-renowned WordPress CMS so the business owner can update and add their own content. The site can also include a blog if required.
                      </p>
                    </div>
                  </div>
                  <div class="col-12 col-md-6 col-lg-4">
                ...
                <div class="row">
                  <div class="col-12 col-md-6 col-lg-4">
                    <div class="box">
                      <img src="/img/wordpress.svg" alt="Wordpress CMS" class="icon">
                      <p>
                        Your site will be built on the world-renowned WordPress CMS so the business owner can update and add their own content.
                      </p>
                    </div>
                  </div>
                  <div class="col-12 col-md-6 col-lg-4">
