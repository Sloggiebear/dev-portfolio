<!DOCTYPE html>
    ...
    <main>
        <header class="container-fluid section-header pt-3">
          <div class="row h-100">
        ...
        <section id="services" class="section-services">
          ...
          <section class="container">
            <div class="row pt-5 pb-3 pb-lg-5">
              ...
              <div class="col-12 col-lg-6 order-1 order-lg-2 pb-4 pb-lg-0">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 511.98 512" id="wordpress-drawing" height="400px" width="auto" class="d-block mx-auto draw-out">
